...
def optimize_printing(print_jobs: List[Dict], constraints: Dict) -> Dict:
    ...
    # Сортуємо завдання за пріоритетом (зростанням) та за часом друку (зменшенням)
    ...
    while jobs:
        ...
        # Формуємо групу завдань для друку
        for job in jobs[:]:
        ...
        # Розраховуємо час для групи як максимальний час друку
        if current_batch:
